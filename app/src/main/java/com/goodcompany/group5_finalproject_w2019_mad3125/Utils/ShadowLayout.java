...
public class ShadowLayout extends FrameLayout {
    ...
    private final static float DEFAULT_SHADOW_RADIUS = 0.0F;
    private final static float DEFAULT_SHADOW_DISTANCE = 0.0F;
    private final static float DEFAULT_SHADOW_ANGLE = 0.0F;
    private final static int DEFAULT_SHADOW_COLOR = Color.TRANSPARENT;
    ...
    public void setShadowAlpha(@IntRange(from = MIN_ALPHA, to = MAX_ALPHA) final int shadowAlpha) {
        if (shadowAlpha == 0) {
            resetShadow();
        } else {
